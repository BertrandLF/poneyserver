...
import com.ninja_squad.ponyserver.web.security.AuthenticationInterceptor;
import com.ninja_squad.ponyserver.web.security.CorsFilter;
...
public class AppConfig extends WebMvcConfigurerAdapter {
    ...
    public Docket ponyApi() {
        return new Docket(DocumentationType.SWAGGER_2)
            .apiInfo(new ApiInfo("PonyServer", "The backend for your awesome PonyRacer application", "2.0", null, "contact@ninja-squad.com", null, null))
            .select()
